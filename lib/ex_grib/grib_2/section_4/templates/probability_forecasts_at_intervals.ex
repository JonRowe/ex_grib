defmodule ExGrib.Grib2.Section4.Templates.ProbabilityForecastsAtIntervals do
  @moduledoc """
  Template 4.9

  Probability forecasts at intervalstal level or in a horizontallayer in a continuous or non-continuous time interval
  ...
  (3)An increment of zero means that the statistical processing the result
    ...
    The reference and forecast times are successively set to their initial
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-9.shtml
  """
  ...
  defstruct parameter_category: nil,
            ...
            forecast_probability_number: nil,
            total_number_of_forecast_probabilities: nil,
            probability_type: nil,
            scale_factor_of_lower_limit: nil,
            scaled_value_of_lower_limit: nil,
            scale_factor_of_upper_limit: nil,
            scaled_value_of_upper_limit: nil,
  ...
  def get(<<
        ...
        forecast_probability_number::integer(),
        total_number_of_forecast_probabilities::integer(),
        # Probability Type (see Code  Table 4.9)
        probability_type::integer(),
        scale_factor_of_lower_limit::integer(),
        scaled_value_of_lower_limit::integer-size(32),
        scale_factor_of_upper_limit::integer(),
        scaled_value_of_upper_limit::integer-size(32),
    ...
    template = %__MODULE__{
      ...
      forecast_probability_number: forecast_probability_number,
      total_number_of_forecast_probabilities: total_number_of_forecast_probabilities,
      probability_type: probability_type,
      scale_factor_of_lower_limit: scale_factor_of_lower_limit,
      scaled_value_of_lower_limit: scaled_value_of_lower_limit,
      scale_factor_of_upper_limit: scale_factor_of_upper_limit,
      scaled_value_of_upper_limit: scaled_value_of_upper_limit,
