defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedAtIntervalsForAtmosphericChemicalConstituents do
  @moduledoc """
  Template 4.43

  Individual ensemble forecast control and perturbed at intervals for atmospheric chemical constituentsn a continuous or non-continuous time interval for atmospheric chemical constituents
  ...
  values plus or minus the increment, as defined by the type
    of time increment (one of octets 5i3, 65,77, ...). For all but the innermost (last)
  time range, the next inner range is then
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-43.shtml
  """
