defmodule ExGrib.Grib2.Section4.Templates.DerivedForecastsBasedOnAllEnsembleMembersAtIntervals do
  @moduledoc """
  Template 4.12

  Derived forecasts based on all ensemble members at intervalstal levelor in a horizontal layer in a continuous or non-continuous time interval
  ...
  increment, as defined by
    the type of time
  increment (one of octets 50, 62, 74 ...). For all but the
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-12.shtml
  """
