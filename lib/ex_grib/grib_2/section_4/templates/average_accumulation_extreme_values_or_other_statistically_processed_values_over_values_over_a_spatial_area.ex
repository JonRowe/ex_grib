defmodule ExGrib.Grib2.Section4.Templates.AverageAccumulationExtremeValuesOrOtherStatisticallyProcessedValuesOverValuesOverASpatialArea do
  @moduledoc """
  Template 4.15

  Average accumulation extreme values or other statistically processed values over values over a spatial areaea at horizontal level or in a horizontal layer at a point in time
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-15.shtml
  """
  ...
  defstruct parameter_category: nil,
            ...
            statistical_process_used_within_the_spatial_area_defined_by_octet: nil,
            type_of_spatial_processing_used_to_arrive_at_given_data_value_from_source_data: nil,
            number_of_data_points_used_in_spatial_processing_defined_in_octet: nil
  ...
  def get(<<
        ...
        statistical_process_used_within_the_spatial_area_defined_by_octet::integer(),
        # Type of spatial processing used to arrive at given data value from source data (see Code Table 4.15)
        type_of_spatial_processing_used_to_arrive_at_given_data_value_from_source_data::integer(),
        # Number of data points used in spatial processing defined in octet 36
        number_of_data_points_used_in_spatial_processing_defined_in_octet::integer(),
        rest::binary()
      >>) do
    template = %__MODULE__{
      ...
      statistical_process_used_within_the_spatial_area_defined_by_octet:
        statistical_process_used_within_the_spatial_area_defined_by_octet,
      type_of_spatial_processing_used_to_arrive_at_given_data_value_from_source_data:
        type_of_spatial_processing_used_to_arrive_at_given_data_value_from_source_data,
      number_of_data_points_used_in_spatial_processing_defined_in_octet:
        number_of_data_points_used_in_spatial_processing_defined_in_octet
    }
