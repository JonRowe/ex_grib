defmodule ExGrib.Grib2.Section4.Templates.ProbabilityForecasts do
  @moduledoc """
  Template 4.5

  Probability forecasts at a horizontal levelor in a horizontal layer at a point in time
  ...
  def get(<<
        ...
        scaled_value_of::integer-size(32),
        rest::binary()
      >>) do
    template = %__MODULE__{
      ...
      scaled_value_of: scaled_value_of
    }
