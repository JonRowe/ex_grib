defmodule ExGrib.Grib2.Section4.Templates.AverageAccumulationAtIntervalsForAerosol do
  @moduledoc """
  Template 4.46

  Average accumulation at intervals for aerosolor other statistically-processedvalues at a horizontal level or in a horizontal layer in a continuousor non-continuous time interval for aerosol
