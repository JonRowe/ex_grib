defmodule ExGrib.Grib2.Section4.Templates.DerivedForecastsBasedOnAClusterOfEnsembleMembersOverARectangularAreaAtIntervals do
  @moduledoc """
  Template 4.13

  Derived forecasts based on a cluster of ensemble members over a rectangular area at intervalstal level or in a horizontal layer in a continuous or non-continuous time interval
  ...
  increment, as defined by
    the type of time
  increment (one of octets 82, 94, 106 ...). For all but the
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-13.shtml
  """
  ...
  def get(<<
        ...
        # Parameter number (see Code Table 4.1)
        ...
        # As octets 81 to 92 next innermost step of processing
        as_octets::integer-size(96),
        # Additional time range specifications included in accordance with the value of n Contents as octets 81 to 92 repeated as necessary.
