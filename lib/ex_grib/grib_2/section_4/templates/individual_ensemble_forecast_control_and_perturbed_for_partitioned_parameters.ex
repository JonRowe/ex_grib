defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedForPartitionedParameters do
  @moduledoc """
  Template 4.54

  Individual ensemble forecast control and perturbed for partitioned parametersr in a horizontal layer at a point in  time for partitioned parameters
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-54.shtml
  """
  ...
  def get(<<
        ...
        forecast_time_in_units_defined_by_octet::integer-size(248),
