defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedIntervalForSpatioTemporalChangingTileParametersDeprecated do
  @moduledoc """
  Template 4.59

  Individual ensemble forecast control and perturbed interval for spatio temporal changing tile parameters deprecated point in time interval for spatio-temporal changing tile parameters

  Notes:

  (1)   The number of used tiles (NUT) is the number of used different spatial tiles,
  defining the cover structure of point. As each of these tiles has one or more different tile
  attributes A(NAT(ITN)), where (ITN=1,...,NUT), for example, (unmodified, snow-covered,...), there are
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-59.shtml
  """
  ...
  def get(<<
        ...
        # Attribute of tile (see Code table 4.241) (A={A(1) ... A(NAT(ITN))}) (See Note 2)
