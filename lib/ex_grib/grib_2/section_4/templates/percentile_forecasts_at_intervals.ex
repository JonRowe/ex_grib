defmodule ExGrib.Grib2.Section4.Templates.PercentileForecastsAtIntervals do
  @moduledoc """
  Template 4.10

  Percentile forecasts at intervalstal level or in a horizontallayer in a continuous or non-continuous time interval
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-10.shtml
  """
  ...
  def get(<<
        ...
        forecast_time_in_units_defined_by_previous_octet::integer-size(32),
