defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedAtIntervalsForAerosol do
  @moduledoc """
  Template 4.47

  Individual ensemble forecast control and perturbed at intervals for aerosolor in a horizontal layer in a continuous or non-continuous time interval for aerosol
  ...
  rain guage. The reference and forecast
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-47.shtml
  """
