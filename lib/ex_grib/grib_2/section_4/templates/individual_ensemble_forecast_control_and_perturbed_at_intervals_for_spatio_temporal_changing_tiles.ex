defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedAtIntervalsForSpatioTemporalChangingTiles do
  @moduledoc """
  Template 4.63

  Individual ensemble forecast control and perturbed at intervals for spatio temporal changing tileser in a continuous or non-continuous time interval for spatio-temporal changing tiles
  ...
  (6)The reference and forecast times are successively set to their initial values
    ...
    (one of octets 57, 69, 81,...). For all but the innermost (last) time range,
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-63.shtml
  """
  ...
  defstruct parameter_category: nil,
            ...
            minutes_of_observational_data_cutoff_after_reference: nil,
  ...
  def get(<<
        ...
        minutes_of_observational_data_cutoff_after_reference::integer(),
        ...
        # As octets 56 to 67 next innermost step of processing
    ...
    template = %__MODULE__{
      ...
      hours_of_observational_data_cutoff_after_reference_time:
        hours_of_observational_data_cutoff_after_reference_time,
      minutes_of_observational_data_cutoff_after_reference:
        minutes_of_observational_data_cutoff_after_reference,
