defmodule ExGrib.Grib2.Section4.Templates.IndividualEnsembleForecastControlAndPerturbedAtIntervals do
  @moduledoc """
  Template 4.11

  Individual ensemble forecast control and perturbed at intervalsontallevel or in a horizontal layer in a continuous or non-continuous time interval
  ...
  (4)The reference and forecast times are successively set to their initial values
  ...
  https://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_doc/grib2_temp4-11.shtml
  """
